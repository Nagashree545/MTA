        ...
        <div className={styles.sirContainer}>
          ...
          <div className={styles.sirContent}>
            ...
            <p className={styles.sirDesc}>
              <strong>Trader Trainer & Stock Market Psychologist</strong>, Anand Patil is a seasoned market professional with deep expertise in
              technical analysis, price action trading, and risk management.
              With years of experience in the financial markets, he has
        ...
        <div className={styles.whatsetContainer}>
          ...
          <div className={styles.whatsetFeatureGrid}>
            ...
            <div className={styles.whatsetFeatureCard}>
              ...
              <p>
                Understand the mindset required for successful trading and learn how to control emotions like fear and greed.
              </p>
            </div>
            ...
            <div className={styles.whatsetFeatureCard}>
              <div className={styles.whatsetFeatureIcon}>📘</div>
              <h3>Structured Learning Program</h3>
              <p>
                Learn trading step-by-step with a well-organized curriculum designed to build strong fundamentals and advanced strategies.
              </p>
            </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.missionWhiteWrapper}>
            ...
            <div className={styles.missionWhiteContent}>
              <p>
                At Master Traders Academy, we focus on delivering practical trading knowledge
                that helps individuals understand the market with clarity and confidence.
              </p>

              <p>
                We aim to simplify complex concepts and provide the right guidance so that
                anyone can start their trading journey with a strong foundation.
              </p>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.visionWrapper}>
            <div className={styles.visionContent}>
              <p>
                Our vision is to create a platform where individuals can learn, grow, and
                adapt to the ever-changing financial markets with clarity and discipline.
                We strive to build traders who think independently and act with confidence.
              </p>
              <p>
                We aim to shape a new generation of traders who are equipped with the right
                mindset, skills, and strategies to navigate the market with consistency and control.
              </p>
          ...
          <div className={styles.benefitsGrid}>
            ...
            <div className={styles.benefitItem}>
              ...
              <div className={styles.benefitText}>
                ...
                <p>Receive personalized guidance from experienced mentors to strengthen your trading approach</p>
              </div>
            </div>
            <div className={styles.benefitItem}>
              <span className={styles.checkmark}>✓</span>
